...
extension GIFAnimatable {
    ...
    public var gifLoopDuration: NSTimeInterval {
    ...
    /// - parameter loopCount: Desired number of loops, <= 0 for infinite loop.
    public func animate(withGIFData imageData: NSData, loopCount: Int = 0) {
    ...
    /// - parameter imageData: GIF image data.
    /// - parameter loopCount: Desired number of loops, <= 0 for infinite loop.
    public func prepareForAnimation(withGIFData imageData: NSData, loopCount: Int = 0, completionHandler: ((Void) -> Void)? = .None) {
    ...
    public func setShouldResizeFrames(resize: Bool) {
    ...
    public func setFrameBufferCount(frames: Int) {
